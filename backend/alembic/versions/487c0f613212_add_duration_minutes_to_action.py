"""add duration_minutes to action

Revision ID: 487c0f613212
Revises: 3ddb370b0a94
Create Date: 2026-02-28 20:53:41.628281
...
revision: str = '487c0f613212'
down_revision: Union[str, Sequence[str], None] = '3ddb370b0a94'
...
def upgrade() -> None:
    ...
    op.add_column('action', sa.Column('duration_minutes', sa.Integer(), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('action', 'duration_minutes')
