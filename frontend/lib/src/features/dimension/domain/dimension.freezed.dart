...
mixin _$Dimension {
  String get id =>
      throw _privateConstructorUsedError; // Slug: energy, clarity, etc.
...
class _$DimensionImpl implements _Dimension {
  ...
  @override
  String toString() {
    return 'Dimension(id: $id, name: $name, description: $description)';
  }
...
abstract class _Dimension implements Dimension {
  ...
  @override
  String get id; // Slug: energy, clarity, etc.
  @override
  String get name;
  @override
